<template>
    <section class="mt-24 px-4 sm:px-6 lg:px-8 font-montserrat">
      ...
      <div class="relative responsive-wrapper">
        <transition-group
          name="fade"
          tag="div"
...
<div class="flex items-center mb-3">
  ...
  export default {
    ...
    data() {
      return {
        ...
        visibleReviews: [],
        currentIndex: 0,
        reviewsPerPage: 6, // показуємо 6 одночасно (3 в 2 ряди)
        interval: null,
      };
    },
    mounted() {
  ...
  if (position <= Math.floor(rating)) {
    ...
    return 'text-yellow-300'; // напівзірка
  } else {
...
/* Адаптивна мінімальна висота для мобільного */
.responsive-wrapper {
  min-height: auto;
}
