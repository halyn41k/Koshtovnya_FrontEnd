<template>
  <aside
    class="order-summary flex-shrink-0 w-full lg:w-64 bg-white dark:bg-[#1a2238] border border-gray-200 dark:border-gray-700 rounded-2xl p-4 font-montserrat shadow-md"
  >
    ...
    <div class="flex justify-between items-baseline mb-6">
      <span class="text-xl font-semibold text-[#6B1F1F] dark:text-white">
        {{ formatCurrencyIntl(totalSum, detectedCurrency) }}
      </span>
    </div>
