<template>
  <div>
    ...
    <PaymentSummary :cartItems="localCartItems" :deliveryCost="deliveryCost" :totalAmount="calculatedTotalAmount"
      :cityRef="formData.city" :deliveryType="formData.deliveryType" @submit-payment="submitOrder" />
  </div>
</template>
