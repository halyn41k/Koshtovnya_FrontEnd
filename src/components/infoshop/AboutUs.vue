...
export default {
  ...
  setup() {
    ...
    const faqAnswers = ref([
      ...
      `Так, ми пропонуємо можливість створення прикрас за індивідуальним запитом. Ви можете обрати дизайн, кольори та розміри, які відповідають вашим особистим вподобанням. Зв'яжіться з нами для обговорення деталей, і ми створимо унікальний виріб спеціально для вас.`
    ]);
